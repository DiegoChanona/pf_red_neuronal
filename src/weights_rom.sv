...
//
// Layout neuron-major (spec seccion 4.8):
...
// direcciones de una pasada son contiguas, pero las dejo sueltas para no amarrar el
// modulo a ese supuesto.
module weights_rom #(
  ...
  initial $readmemh("tb/weights.hex", mem);
